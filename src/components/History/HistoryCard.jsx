...
function HistoryCard({thumbnail, title, author, history, reviewUrl}) {
  return (
    <div className='box-border mt-4 border border-slate-300 px-3 py-4 w-11/12 m-auto rounded-lg flex items-center justify-start gap-5 font-poppins h-fit'>
        ...
        <div className='flex flex-col gap-1 justify-around w-2/5 break-word'>
            ...
            <p className='mt-1 text-sm text-[#B1ADAD]'>{`peminjaman ${history}`}</p>
        </div>
        <Link to={reviewUrl} className='border border-[#035C95] px-4 py-1 rounded-md text-[#035C95] justify-self-end text-sm'>
